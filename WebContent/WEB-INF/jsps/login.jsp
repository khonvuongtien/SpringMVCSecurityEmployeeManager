...
<script src="${pageContext.request.contextPath }/static/js/cufon-yui.js"
	type="text/javascript"></script>
<script
	src="${pageContext.request.contextPath }/static/js/ChunkFive_400.font.js"
	type="text/javascript"></script>
	...
	<div class="wrapper">
		...
		<div class="content">
			<div id="form_wrapper" class="form_wrapper">
				<h3>Login</h3>
				<form class="login active" name='f'
					action='/ps04823_java5_asm/login' method='POST'>
					 <div>
						<label>Username:</label> <input type='text' name='username'
							value='' /> <span class="error">This is an error</span>
					</div>
					<div>
						<label>Password: <a href="forgot_password.html"
							rel="forgot_password" class="forgot linkform">Forgot your
								password?</a></label> <input type='password' name='password' /> <span
				...
				<form class="forgot_password" action="${pageContext.request.contextPath}/recoverpass" method="GET">
					<h3>Forgot Password</h3>
					<div>
						<label>Email:</label> <input name="username" type="text" /> <span
							class="error">This is an error</span>
					</div>
					<div class="bottom">
